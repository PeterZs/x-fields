...
def Flow(input_coordinates,h_res,w_res,num_out,ngf):
    ...
    coordconv    = tf.constant([[[[-w_res, -h_res],[w_res, -h_res]], [[-w_res, h_res], [w_res,h_res]]]],dtype=tf.float32)
#    coordconv    = tf.constant([[[[0, 0],[1, 0]], [[0, 1], [1,1]]]],dtype=tf.float32)
